...
import Bedroom from "../../assets/projects/residential/mrs_veena/1.jpg";
...
export default function WhatWeOffer() {
  ...
  return (
    <>
      ...
      <div className="bg-primary pb-16 -mt-20 rounded-3xl">
        <div className="text-white pt-32 text-center ">
          <div className="flex space-x-3 items-center justify-center">
            <div className="bg-white w-2 h-4 rounded-l-full"></div>
        ...
        <div className=" md:px-10">
          ...
          <div className="border w-[93%]  mx-auto py-4 rounded-full mt-8 md:w-2/3 ">
            <p className="text-white w-5/6 mx-auto text-center md:flex md:justify-center">
              Need more services based on your demand?{" "}
              <span className="text-white  hidden md:flex md:px-3">
                Contact us
              </span>
            </p>
            <p className="text-white text-center md:hidden">Contact us</p>
          </div>
        </div>
      </div>
